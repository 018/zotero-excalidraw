...
if (!Zotero.ZoteroExcalidraw.Items) Zotero.ZoteroExcalidraw.Items = {};

Zotero.ZoteroExcalidraw.Items = Object.assign(Zotero.ZoteroExcalidraw.Items, {
	init() {
		Zotero.ZoteroExcalidraw.Logger.log('Zotero.ZoteroExcalidraw.Items inited.');
	},
  ...
  //   let links = [];
	// 	if (collection) {
  //     links.push(...Zotero.ZoteroExcalidraw.Collections.links(collection.id));
	// 	} else if(search) {
  ...
  selectItem(collectionID, itemID) {
    if (collectionID) {
      Zotero.ZoteroExcalidraw.Collections.selectCollection(collectionID).then(() => {
  ...
  selectItemFromLibraryAndKey(libraryID, collectionKey, key) {
    ...
    Zotero.ZoteroExcalidraw.Collections.selectCollectionFromLibraryAndKey(libraryID, collectionKey).then(() => {
