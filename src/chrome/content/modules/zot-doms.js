...
if (!Zotero.ZoteroExcalidraw.Doms) Zotero.ZoteroExcalidraw.Doms = {};

Zotero.ZoteroExcalidraw.Doms = Object.assign(Zotero.ZoteroExcalidraw.Doms, {
	init() {
		Zotero.ZoteroExcalidraw.Logger.log('Zotero.ZoteroExcalidraw.Doms inited.');
	},
