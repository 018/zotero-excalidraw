...
if (!Zotero.ZoteroExcalidraw.DateTimes) Zotero.ZoteroExcalidraw.DateTimes = {};

Zotero.ZoteroExcalidraw.DateTimes = Object.assign(Zotero.ZoteroExcalidraw.DateTimes, {
  yyyyMM: 'yyyy-MM',
  yyyyMMdd: 'yyyy-MM-dd',
  ...
  yyyyMMddHHmmssS: 'yyyy-MM-dd HH:mm:ss.S',
	...
	init() {
		Zotero.ZoteroExcalidraw.Logger.log('Zotero.ZoteroExcalidraw.DateTimes inited.');
	},
  ...
  now() {
    return this.formatDate(new Date(), Zotero.ZoteroExcalidraw.DateTimes.yyyyMMddHHmmssS);
  },
