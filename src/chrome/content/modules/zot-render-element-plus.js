    ...
    Consts: {
      date_picker_shortcuts: [
        ...
        },
        {
          ...
          value: () => {
            const date = new Date();
            let startOfWeek = Zotero.ZoteroExcalidraw.Prefs.get('startOfWeek', Zotero.ZoteroExcalidraw.Consts.startOfWeek.sunday);
    ...
    Console: {
      log(data) {
        if (ZotElementPlus.isZoteroDev) {
          ...
          Zotero.ZoteroExcalidraw.Logger.log(data);
        }
      }
    }
  }
